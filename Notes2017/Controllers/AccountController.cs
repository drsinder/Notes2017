...
**
**  Description:
**      Account Controller for Notes 2017
**
...
using Notes2017.Models.AccountViewModels;
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email, "Confirm your account",
                        "Please confirm your Notes 2017 account by clicking this link: <a href=\"" + callbackUrl + "\">Confirm your account</a>");
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Reset Password",
                   "Please reset your Notes 2017 password by clicking here: <a href=\"" + callbackUrl + "\">link</a>");
                return View("ForgotPasswordConfirmation");
            }
